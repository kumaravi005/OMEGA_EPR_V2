...
final reportTemplateRepositoryProvider = Provider<FirestoreRepository<ReportTemplate>>((ref) {
...
final templatesForModuleProvider = StreamProvider.family<List<ReportTemplate>, ReportModule>((ref, module) {
  return ref
      .watch(reportTemplateRepositoryProvider)
      .watchAll()
      .map((templates) => templates.where((t) => t.module == module).toList()..sort((a, b) => a.name.compareTo(b.name)));
});
