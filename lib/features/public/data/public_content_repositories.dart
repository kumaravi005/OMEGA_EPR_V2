...
final galleryRepositoryProvider = Provider<FirestoreRepository<GalleryItem>>((ref) {
...
final bannerRepositoryProvider = Provider<FirestoreRepository<BannerItem>>((ref) {
...
final upcomingBatchRepositoryProvider = Provider<FirestoreRepository<UpcomingBatch>>((ref) {
...
final allUpcomingBatchesProvider = StreamProvider<List<UpcomingBatch>>((ref) {
  return ref
      ...
      .watchAll()
      .map((items) => items.toList()..sort((a, b) => a.startDate.compareTo(b.startDate)));
});

final advertisementRepositoryProvider = Provider<FirestoreRepository<Advertisement>>((ref) {
...
final announcementRepositoryProvider = Provider<FirestoreRepository<Announcement>>((ref) {
...
final instituteProfileRepositoryProvider = Provider<FirestoreRepository<InstituteProfile>>((ref) {
...
final instituteProfileProvider = StreamProvider<InstituteProfile?>((ref) {
  return ref.watch(instituteProfileRepositoryProvider).watchById(InstituteProfile.documentId);
});
