...
final reportLayoutTemplateRepositoryProvider =
    Provider<FirestoreRepository<ReportLayoutTemplate>>((ref) {
...
final allReportLayoutTemplatesProvider =
    StreamProvider<List<ReportLayoutTemplate>>((ref) {
      return ref
          .watch(reportLayoutTemplateRepositoryProvider)
          .watchAll()
          .map(
            (templates) =>
                templates.toList()..sort((a, b) => a.name.compareTo(b.name)),
          );
    });
